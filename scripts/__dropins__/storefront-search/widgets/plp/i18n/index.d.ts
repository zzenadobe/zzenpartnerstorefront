...
export { ar_AE, bg_BG, bn_IN, ca_ES, cs_CZ, da_DK, de_DE, el_GR, en_GA, en_GB, en_US, es_ES, et_EE, eu_ES, fa_IR, fi_FI, fr_FR, gl_ES, hi_IN, hu_HU, hy_AM, id_ID, it_IT, ja_JP, ko_KR, lt_LT, lv_LV, nb_NO, nl_NL, pt_BR, pt_PT, ro_RO, ru_RU, Sorani, sv_SE, th_TH, tr_TR, zh_Hans_CN, zh_Hant_TW, };
